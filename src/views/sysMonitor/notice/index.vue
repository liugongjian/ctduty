  ...
  <div class="notice">
    <div>
      ...
      >
        ...
        <el-table-column label="公告标题" align="left">
        ...
        <el-table-column label="创建者" prop="creator.name" align="center"></el-table-column>
...
export default {
  ...
  watch: {
    "addNoticeForm.content"(v) {
      if (v.length > 300) {
        this.addNoticeForm.content = v.slice(0, 299);
        this.$message({
          type: "warning",
          message: "内容长度不能大于300!!!"
        });
    ...
    "addNoticeForm.title"(v) {
      if (v.length > 25) {
        this.addNoticeForm.title = v.slice(0, 24);
        this.$message({
          type: "warning",
          message: "标题长度不能大于25!!!"
        });
    ...
    "editNoticeForm.title"(v) {
      if (v.length > 25) {
        this.editNoticeForm.title = v.slice(0, 24);
        this.$message({
          type: "warning",
          message: "标题长度不能大于25!!!"
        });
    ...
    "editNoticeForm.content"(v) {
      if (v.length > 300) {
        this.editNoticeForm.content = v.slice(0, 299);
        this.$message({
          type: "warning",
          message: "内容长度不能大于300!!!"
        });
...
>>>>>>> 3b0fa11da72a61564d3fc3eb50cfee6a59f59065
      }
