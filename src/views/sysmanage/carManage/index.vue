  ...
  <div class="list">
    ...
    <div class="app-container" style="padding: 20px">
      <div class="filter-container clearfix">
        <div class="pull-left">
          <el-button class="filter-item" type="warning" icon="el-icon-plus" @click="create">{{ '新增车辆数据' }}</el-button>
          <el-button class="filter-item" type="warning" @click="bulkimport ">{{ '导入车辆数据' }}</el-button>
          <el-button type="text" size="small" @click="batchesDel">{{ '批量删除' }}</el-button>
          <el-dialog :visible="bulkimportVisble" title="导入车辆数据" width="90vw" height="70vh" @close="closebulkimportDialog">
            <el-upload
              class="upload-demo"
              drag
              list-type="picture"
          ...
          <el-dialog :visible="dialogVisable" title="新增车辆数据" width="520px" @close="closeDialog">
