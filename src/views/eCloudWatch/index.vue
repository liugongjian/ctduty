    ...
    getCameraList() {
      ...
      fetchAllCameraList(params).then(res => {
        ...
        this.formInfo.forEach((item, index) => {
          ...
          if (!this.cameraAlarmObj[item.id]) {
            this.markers.push({
              position: [
                item.longitude,
                item.latitude
